...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { url: "/consulting", changeFrequency: "monthly" as const, priority: 0.9 },
    { url: "/invest", changeFrequency: "monthly" as const, priority: 0.9 },
    { url: "/mobility", changeFrequency: "monthly" as const, priority: 0.9 },
    { url: "/managed-services", changeFrequency: "monthly" as const, priority: 0.9 },
