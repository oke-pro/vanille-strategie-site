...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed z-50 flex h-12 w-12 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-all hover:scale-110 hover:bg-green-600 ${
        chatOpen ? "bottom-6 right-20" : "bottom-[5.5rem] right-6"
      }`}
